Shader "Jeremy/Boss/BossGlass"
{
    ...
    {  
        ...
        CBUFFER_START(UnityPerMaterial)
            ...
            half4 _number;
            float4 _MainTex_ST;
            half4 _SpacularColor,_FresnelColor,_Color;
            half4 _vect;
            // int _Illum;
            half4 _Illumindex;
        CBUFFER_END
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half NdotL = dot(N,L);
                half4 lambert = ( 0.35  + saturate( saturate(NdotL) / _number.x  + _number.y ) ) * mainTex * _MainLightColor;
