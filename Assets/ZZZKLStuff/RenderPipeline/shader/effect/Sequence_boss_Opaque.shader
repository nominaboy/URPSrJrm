Shader "Jeremy/Sequence/SequenceBoss_Opaque"
{
    Properties
    {
        _MainTex("MainTex",2D) = "white"{}
        // _DarkColor("Dark Color",Color)=(0.75,0.9,1,1)
        [Header(H(X)  W(y)  frame(z)  null(w))]
        [Space]
        _Sequence("",vector)=(2,2,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                half2 offset = normalize(normalCS.xy) * _OutlineLen * o.positionCS.w ; /// _ScreenParams.xy 
        ...
        //         worldPos.y = _ShadowOffsest.y;
        //         worldPos.xz += _ShadowOffsest.xz*(worldPosY - _ShadowOffsest.y);
        //         o.pos = TransformWorldToHClip(worldPos);
        //         o.uv = worldPos.xz/_ShadowOffsest.w * 0.75;
        //         return o;
        //     }
        ...
        //         half4 dotMap = SAMPLE_TEXTURE2D(_dotMap, sampler_dotMap, i.uv.xy);
